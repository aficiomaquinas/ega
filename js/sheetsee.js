...
//font-size piechart BIG
  var textSelector = "." + "labels-" + indexValue
  var selectedText = d3.selectAll(textSelector)
  selectedText.transition()
    .duration(150)
    .style("font-size", "42px").style("font-weight", "bold").style("fill", options.hiColor)
...
//font-size piechart small
  var textSelector = "." + "labels-" + indexValue
  var selectedText = d3.selectAll(textSelector)
  selectedText.transition()
    .duration(200)
    .style("font-size", "32px").style("font-weight", "normal").style("fill", function(d) { return d.hexcolor })
  }
  ...
  .enter().append("g") // Append legend elements
      .append("text")
        ...
        // modify label Piechart "Label, value"
